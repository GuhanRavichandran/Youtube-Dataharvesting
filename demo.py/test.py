...
if show_tables ==":red[Channels]": 
  st.slider(":red[Total subscribers]",200,5000000,(10000,500000)) 
...
if show_tables==":red[Videos]":
  st.slider(":red[Total views]",2000,1500000000,(200000000,600000000))
...
if show_tables==":red[comments]":
  st.slider(":red[Total comments]",0,7000,(100,2500))
